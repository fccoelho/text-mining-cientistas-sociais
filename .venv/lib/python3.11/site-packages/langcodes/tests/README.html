...
const thebe_selector_output = ".output, .cell_output"
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.11/site-packages/langcodes/tests/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/fccoelho/text-mining-cientistas-sociais/issues/new?title=Issue%20on%20page%20%2F.venv/lib/python3.11/site-packages/langcodes/tests/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.venv/lib/python3.11/site-packages/langcodes/tests/README.md" target="_blank"
...
<div id="searchbox"></div>
  ...
  <p>Most of the tests for langcodes are in doctests, intended to be run on Python 3. This directory contains additional tests that ensure langcodes can recognize language names as they are used on Wiktionary, the free multilingual dictionary.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib/python3.11/site-packages/langcodes/tests"
        },
